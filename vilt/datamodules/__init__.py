...
from .person_pretrain_datamodule import PersonPretrainDataModule
from .LUPerson_pretrain_datamodule import LUPersonPretrainDataModule
...
_datamodules = {
    ...
    "PP":PersonPretrainDataModule,
    "LPP":LUPersonPretrainDataModule
}
